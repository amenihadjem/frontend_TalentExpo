...
export const Logo = forwardRef((props, ref) => {
  ...
  const CONFIG = {
    assetsDir: '/logo', // This now points directly to your public/logo folder
  };

  const singleLogo = (
    <img alt="Single logo" src={`${CONFIG.assetsDir}/logo-single.png`} width="100%" height="100%" />
  );

  const fullLogo = (
    <img alt="Full logo" src={`${CONFIG.assetsDir}/logo-full.png`} width="100%" height="100%" />
  );
