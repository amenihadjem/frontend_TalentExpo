...
function Controller({ children, ...props }) {
  ...
  return React.createElement("div", { ref: handleContainerRef, className: clsx(cssClass(cssContainerPrefix()), cssClass(CLASS_FLEX_CENTER)), style: {
    ...
    ...styles.container
  }, ...controller.aria ? { role: "region", "aria-live": "polite", "aria-roledescription": "carousel" } : null, tabIndex: -1, ...registerSensors }, containerRect && React.createElement(
...
function CarouselSlide({ slide, offset }) {
  ...
  return React.createElement("div", { ref: containerRef, className: clsx(cssClass(cssSlidePrefix()), !offscreen && cssClass(cssSlidePrefix("current")), cssClass(CLASS_FLEX_CENTER)), ...makeInertWhen(offscreen), onClick: handleBackdropClick, style, role: "region", "aria-roledescription": "slide" }, renderSlide());
}
...
function Portal({ children, animation, styles, className, on, portal, close }) {
  ...
  return mounted ? (0, import_react_dom.createPortal)(React.createElement(LightboxRoot, { ref: handleRef, className: clsx(className, cssClass(cssPrefix$1()), cssClass(CLASS_NO_SCROLL_PADDING), visible && cssClass(cssPrefix$1("open"))), "aria-modal": true, role: "dialog", "aria-live": "polite", "aria-roledescription": "lightbox", style: {
...
//# sourceMappingURL=chunk-VJIVPDGG.js.map
